using AdventureWorks.Domain.dbo;
...
namespace AdventureWorks.Domain
{
	public partial class AdventureWorksContext : DbContext
	{
		...
		// Unable to generate entity type for table 'Production.ProductDocument'. Please see the
		// warning messages. Unable to generate entity type for table 'Production.Document'. Please
		...
		protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
		{
			...
			{
				optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=AdventureWorks2016;Integrated Security=True");
			}
		}
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Person.Person>(entity =>
			{
				entity.HasKey(e => e.BusinessEntityId);
				...
				entity.HasOne(d => d.BusinessEntity)
					.WithOne(p => p.Person)
					.HasForeignKey<Person.Person>(d => d.BusinessEntityId)
					.OnDelete(DeleteBehavior.ClientSetNull);
			});
